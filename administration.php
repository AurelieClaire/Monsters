<!--page de gestion de la base de données Monsters par l'administrateur du site-->
...
<html lang="fr">
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="administration.php">Admin <span class="sr-only">(current)</span></a>
                    </li>
                </ul>
        ...
        <?php
        	...
        	if($pseudo == 'aurelie' AND $mdp =='aurelie'){?>
                		...
                		<tbody>
                    		<?php foreach ($monsters as $monster) { ?>
                        		<tr>
                            		...
                            		<td><a href="suppression.php?name=<?php echo $monster->getName()?>" >Supprimer </a></td>
        ...
        <?php }
        	...
        	<div>
        		<p class="para1">
        			<br/><br/> Pseudo et/ou Mot de passe incorrects! Veuillez recommencer: 
